...
namespace SMPL.Tools
{
	public static class Extensions
	{
		...
		/// </code>
		/// </summary>
		public static float AnimateUnit(this float progress, Animations animationType,
			AnimationWay animationCurve, bool repeated = false)
		{
			var result = 0f;
		...
		/// </summary>
		public static float MoveTowardTarget(this float number, float targetNumber, float speed,
			bool fpsDependent = true)
		{
		...
		/// </summary>
		public static float MoveAngleTowardAngle(this float angle, float targetAngle, float speed,
			bool fpsDependent = true)
		{
		...
		/// (see <see cref="Time.Delta"/> for info). The result is then returned.
		/// </summary>
		public static Vector2 PointMoveInDirection(this Vector2 point, Vector2 direction,
			float speed, bool fpsDependent = true)
		{
		...
		/// </summary>
		public static Vector2 PointMoveTowardPoint(this Vector2 point, Vector2 targetPoint,
			float speed, bool fpsDependent = true)
		{
